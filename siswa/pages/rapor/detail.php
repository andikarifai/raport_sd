...
<div class='alert alert-warning' role='alert'>
  <center><a href='javascript:if(window.print)window.print()'>
      <button type='button' id="tombolCetak" class='btn btn-success'><span class='glyphicon glyphicon-print' aria-hidden='true'></span>Cetak halaman ini</button></a> <a href="index.php" class="btn btn-warning" id="tombolKembali">Kembali</a></center>
...
<?php
if ($semester == 2) {
  $kepala = "SELECT nama_kepsek, nip_kepsek FROM profil ";
  $tampil = mysqli_query($koneksi, $kepala);
  $i = 1;
  while ($kepsek = mysqli_fetch_assoc($tampil)) {
