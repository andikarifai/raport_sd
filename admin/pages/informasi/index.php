...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            while ($infor = mysqli_fetch_assoc($informasi)) :
            ?>
                <a href="ubah.php?id=<?= encryptId($infor["id_profil"]);  ?>" class="btn btn-primary m-2"><i class="fa fa-edit" aria-hidden="true"> </i> <span></span> Edit Informasi</a>
            <?php endwhile ?>
        </div>
